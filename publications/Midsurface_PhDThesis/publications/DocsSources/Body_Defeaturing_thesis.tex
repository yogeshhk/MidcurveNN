...
\added{Literature survey Section~\ref{sec:survey:defeat} has reviewed various reported approaches of defeaturing. Subsection~\ref{sec:litsurvey:obsdefeat} conclude that these approaches did not adequately leverage the feature information and to a large extent did not consider application domain.}
...
\textbf{Part and \mbox{actions}} & \textbf{CAD Model} & \textbf{Generated \mbox{Midsurface}} & \textbf{Quality of \mbox{Midsurface}} \\ \midrule
...
%%\bigskip
	...
	\begin{figure} [!h]
		\centering
		\includegraphics[width=0.5\linewidth]{..//Common/images/SystemArchitectureDefeat_4.pdf}
...
%		\includegraphics[width=\linewidth]{..//Common/images/SheetMetal_taxonomy_2.pdf}
...
%% 	\begin{figure} [!h]
%%		\centering
%%\includegraphics[width=0.45\linewidth,valign=t]{../Common/images/dormant_labels.pdf}
...
%%%%\bigskip
	...
	\subfloat[Input CAD Model]{\label{fig:midsurfcelljoin:beforedomant}\includegraphics[width=0.5\linewidth,valign=t]{../Common/images/UBracket_part}} \hfill
	\subfloat[Semi-Final Midsurface]{\label{fig:midsurfcelljoin:semimids}\includegraphics[width=0.49\linewidth,valign=t]{../Common/images/MidsurfBracket}} \hfill
	\subfloat[Dormant Tool Bodies Re-application]{\label{fig:midsurfcelljoin:dormant}\includegraphics[width=0.49\linewidth,valign=t]{../Common/images/MidsurfDormantBodies_2}} \hfill
	\subfloat[Final Midsurface]{\label{fig:midsurfcelljoin:finalmids}\includegraphics[width=0.49\linewidth,valign=t]{../Common/images/MidsurfAfterDormant}}
...
%% 	\begin{figure} [!h]
%%		\centering
%%\includegraphics[width=0.55\linewidth,valign=t]{../Common/images/matbranch}
