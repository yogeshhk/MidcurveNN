...
\href{mailto:yogeshkulkarni@yahoo.com}{yogeshkulkarni@yahoo.com}}
}
\maketitle
...
\[
\mathcal{L}_{\text{TIB}} = \alpha\,\mathcal{L}_{\text{Betti}} + \beta\,\mathcal{L}_{\text{integrity}},
\]
where $\mathcal{L}_{\text{Betti}}$ enforces Betti number matching and $\mathcal{L}_{\text{integrity}}$ preserves global topology. These constraints can detect malformed structures that preserve Euler characteristics but violate connectivity. \section{State-of-the-Art Literature Review}
...
\[
39 - 54 + (16 - 5) = 1 - 5,\qquad 39 - 54 + 11 = -4 = -4.
\]
...
\begin{align*}
\hat{f} &= \sum_n N_{\mathrm{sCell}_{3,n}}, \
\hat{e} &= \sum_n N_{\mathrm{sCell}_{3,n}}(4-n) + \sum_n N_{\mathrm{iCell}}, \
\hat{v} &= \sum_n N_{\mathrm{sCell}_{3,n}}(4-2n) + \sum_n N_{\mathrm{iCell}}(2) + \sum_n N_{\mathrm{sCell}_{3,h}}.
\end{align*}
