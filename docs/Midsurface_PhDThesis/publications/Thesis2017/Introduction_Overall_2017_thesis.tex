...
\begin{figure}[h!]
\centering  
\subfloat[Harvester]{\label{fig:introduction:harvester}\includegraphics[width=0.16\linewidth]{images/SheetMetal_isd_cad_blech_vermeer}} \quad
\subfloat[Enclosure]{\label{fig:introduction:enclosure}\includegraphics[width=\myfigstairspcolumnwidth\linewidth]{images/SheetMetal_Medium_Enclosure_OriginalPart}} \quad
\subfloat[Bracket]{\label{fig:introduction:bracket}\includegraphics[width=\myfigstairspcolumnwidth\linewidth]{images/SheetMetal_Simple_UBracket_OriginalPart}}   \quad
\subfloat[Duct]{\label{fig:introduction:duct}\includegraphics[width=\myfigstairspcolumnwidth\linewidth]{images/SheetMetal_KDuct-Main-Render}}
