/*******************************************************************************
*       FILENAME :      subblock.c      DESIGN REF :  FBD(CAD/CAPP)
*
*       DESCRIPTION :   Member functions related to Class SubBlock
*
...
SubBlock::SubBlock(char *blkid,Component *co ,double xmn,double xmx,double ymn, double ymx , double zmn , double zmx)
{
	...
	*/
	...
	printf( "Came to SuBblock constructor with no. %s \n",block_name);
} 
...
Face *SubBlock::Create_Faces()
{
	...
	/*
		...
		The Direction of orientation of vertices is
		OPPOSITE to that of the Addt. block
	...
	*/
    ...
    Vertex *v8  = new Vertex(8,pxn,pyx,pzn);
        ...
        Face    *f1     = new Face(1,ZAXIS,v1,v5,v6,v2);

        // right face

        Face    *f2     = new Face(2,XAXIS,v2,v6,v7,v3);
        f1->Set_nextf(f2);

        // back face

        Face    *f3     = new Face(3,ZAXIS,v4,v8,v7,v3);
        f2->Set_nextf(f3);
...
void SubBlock::Display_by_phigs()
{
    ...
    */
    ...
    Face *tracef = f6;  // gets the first face in the face list
