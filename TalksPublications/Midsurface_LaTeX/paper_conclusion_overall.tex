...
% \begin{tabular}[htp]{@{} p{0.15\linewidth} p{0.2\linewidth}  p{0.2\linewidth} p{0.2\linewidth} p{0.15\linewidth}@{}}
% \toprule
% \textbf{Work}  &	\textbf{Method} &	 \textbf{Problems}  &	 \textbf{Proposed Approach}\\ \midrule
